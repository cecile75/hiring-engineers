...
* Installation of mySQL on the ubuntu VM  
   ...
   Create the datadog user in my database using the following instructions:  
   ...
   Then go back to the ubuntu machine to add mysql metrics to the data sent to Datadog:  
   Create the following mysql.yaml in the Agent’s conf.d directory :   
...
* Clone the database integration dashboard and add test.support.random metric and some other metrics.  
   ...
   [mysql Dashboard - screenshot](https://mysqldashboard.png)  
...
=================
  ...
  [Notification of downtime - screenshot](downtimereached.png)   
