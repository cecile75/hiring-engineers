...
* Add tags to the agent:   
   ...
   *sudo /etc/init.d/datadog-agent restart*   
   ...
   HostMap page:   
   [host map page] (https://app.datadoghq.com/infrastructure/map?fillby=avg%3Acpuutilization&sizeby=avg%3Anometric&groupby=none&nameby=name&nometrichosts=false&tvMode=false&nogrouphosts=false&palette=green_to_orange&paletteflip=false)   
...
=================
   Alert email from the monitor:  
  ![Alert email - screenshot](alert.png)  

  As I didn't receive an email for the downtime period I set, I add another email address to the alert and therefore, receive an email on this address for the update:  
  ![Update of downtime - screenshot](updatedowntime.png)  

  Downtime period is up:
